...
var getRegisteredUser = async function(username, userOrg, isJson) {
	try {
		...
		if (user && user.isEnrolled()) {
			...
			let registrar = caClient.registrar || caClient['_registrar']
			console.log(caClient)
			console.log(registrar )
			console.log(registrar[0])
			let adminUserObj = await client.setUserContext({username: registrar[0].enrollId, password: registrar[0].enrollSecret});
